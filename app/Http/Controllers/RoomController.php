...
class RoomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json(['data' => $rooms, 'message' => 'Lấy danh sách phòng thành công!']); //convert sang json
    }
    ...
    public function show($id)
    {
        ...
        return response()->json(['data' => $room, 'message' => 'Lấy chi tiết phòng thành công!']);
    }
